...
class ResponsibilityLookupableImplTest {
    ...
    void testGetCreateNewUrl() {
        ...
        assertEquals(lookupable.getCreateNewUrl("maintenance.do?returnLocation=RETURN_LOCATION&businessObjectClassName=org.kuali.rice.kim.impl.responsibility.ReviewResponsibilityBo&methodToCall=start"), lookupable.getCreateNewUrl())
