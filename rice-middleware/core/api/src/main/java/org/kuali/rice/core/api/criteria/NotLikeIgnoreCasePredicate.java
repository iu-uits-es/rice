 ...
 */
@XmlRootElement(name = NotLikeIgnoreCasePredicate.Constants.ROOT_ELEMENT_NAME)
@XmlAccessorType(XmlAccessType.NONE)
@XmlType(name = NotLikeIgnoreCasePredicate.Constants.TYPE_NAME, propOrder = {
...
public class NotLikeIgnoreCasePredicate extends AbstractPredicate implements SingleValuedPredicate {
    ...
    /**
     * Constructs an NotLikeIgnoreCaseType for the given path and value.
     *
     ...
     */
    NotLikeIgnoreCasePredicate(String propertyPath, CriteriaValue<?> value) {
    ...
    static class Constants {
        final static String ROOT_ELEMENT_NAME = "notLikeIgnoreCase";
        final static String TYPE_NAME = "NotLikeIgnoreCaseType";
    }
