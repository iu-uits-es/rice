...
public class PredicateTest {
    ...
    public void testBuild() throws Exception {
        ...
        EqualPredicate firstNamePredicate = equal("first.name", "Eric");
        EqualPredicate lastNamePredicate = equal("last.name", "Westfall");
        ...
        assertTrue(foundOr.getPredicates().contains(firstNamePredicate));
        assertTrue(foundOr.getPredicates().contains(lastNamePredicate));
