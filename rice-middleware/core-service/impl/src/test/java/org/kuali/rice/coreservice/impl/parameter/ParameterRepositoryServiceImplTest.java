...
import org.kuali.rice.coreservice.api.parameter.*;
...
public class ParameterRepositoryServiceImplTest {
    ...
    public void test_create_parameter_exists() throws Exception{
        when(dataObjectService.find(argThat(new ClassOrSubclassMatcher<ParameterBo>(
                ParameterBo.class)), any(CompoundKey.class))).thenReturn(bo);
        getParameterRepositoryService().createParameter(parameter);
        verify(dataObjectService, times(1)).find(argThat(new ClassOrSubclassMatcher<ParameterBo>(
    ...
    public void test_create_parameter_does_not_exist() throws Exception{
        ...
        getParameterRepositoryService().createParameter(parameter);
        verify(dataObjectService, times(2)).find(argThat(new ClassOrSubclassMatcher<ParameterBo>(
                ParameterBo.class)), any(CompoundKey.class));
